...
@Tags({ "nuxeo", "get", "document", "acp", "acl" })
@CapabilityDescription("Retrieve a document ACP/ACL from Nuxeo as JSON.")
@SeeAlso({ GetNuxeoDocument.class, GetNuxeoDocumentAudit.class })
@ReadsAttributes({
...
public class GetNuxeoDocumentACP extends AbstractNuxeoProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            // Fetch ACP/ACL
            ACP acp = rep.fetchACPById(doc.getId());
            session.putAttribute(flowFile, VAR_ENTITY_TYPE, acp.getEntityType());
